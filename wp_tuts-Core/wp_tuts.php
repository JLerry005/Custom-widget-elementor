...
class HelloWorldWidgets {
    public function __construct() {
        // add_action( 'init', array( $this, 'register_hello_world_widgets' ) );
		// add_action( 'elementor/widgets/register', 'register_hello_world_widget' );
    }

    public function register_hello_world_widgets() {
		if ( class_exists( '\Elementor\Plugin' ) ) {
				...
				$widgets_manager->register_widget_type( new Elementor_Hello_World_Widget_1() );
				$widgets_manager->register_widget_type( new Elementor_Hello_World_Widget_2() );	
		}
		return;
...
function run_widget(){
	$widget = new HelloWorldWidgets();

	$widget->register_hello_world_widgets();

}
add_action( 'wp_loaded', 'run_widget' );